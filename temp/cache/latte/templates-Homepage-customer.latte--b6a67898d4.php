<?php
// source: C:\xampp\htdocs\Zbysaweb\app\factureModule/templates/Homepage/customer.latte

use Latte\Runtime as LR;

final class Templateb6a67898d4 extends Latte\Runtime\Template
{
	public $blocks = [
...
<div class="container pt-5">
  ...
  <a class="btn bg-primary text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:newCustomer")) ?>"><i class="fa fa-plus"></i> Nový odběratel</a>
  </div>
<div class="pt-2">
...
?>
      <td>
        <a title="upravit" class="btn" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:newCustomer", ['id' => $item->id_customer])) ?>">
