<?php
// source: C:\xampp\htdocs\Zbysaweb\app\factureModule/templates/Homepage/default.latte

use Latte\Runtime as LR;

final class Template5e4ccca744 extends Latte\Runtime\Template
{
	public $blocks = [
...
<div class="container pt-5">
    <div class="d-flex justify-content-between">
        ...
        <a class="btn bg-primary text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:generatePdf")) ?>"><i class="fa fa-plus"></i> Nová faktura</a>
    </div>
    <div class="pt-2">
...
<?php
			...
			?>                            <a title="upravit" class="btn btn-primary confirmation" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:generatePdf", ['id' => $item->id_facture])) ?>">
